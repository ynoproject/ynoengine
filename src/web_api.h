...
namespace Web_API {
	...
	void OnGChatMessageReceived(std::string_view uuid, std::string_view map_id, std::string_view prev_map_id, std::string_view prev_locations, int x, int y, std::string_view msg);
